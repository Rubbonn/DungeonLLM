...
class Weapon(Base, Item):
	...
	damage: Mapped[str]
	damage_type_id: Mapped[int] = mapped_column(ForeignKey('damage_types.id'))
	...
	mastery_property_id: Mapped[int] = mapped_column(ForeignKey('weapon_mastery_properties.id'))
